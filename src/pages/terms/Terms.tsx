...
export default function Terms() {
  ...
  useEffect(() => {
    async function loadTermsContent() {
      try {
        const res = await fetchLegalContent("terms");
        if (res) {
          ...
          <CardContent className="p-6 sm:p-8">
            {loading ? (
              <div className="flex items-center justify-center py-16 gap-3 text-muted-foreground">
                ...
                <span className="text-sm font-medium">Loading Terms of Service...</span>
              </div>
            ) : content ? (
              <div
              ...
              <div className="flex flex-col gap-6 text-muted-foreground text-sm leading-relaxed">
                <p>
                  Welcome to GocalAI. By accessing or using our application and services, you agree to be bound by these Terms of Service.
                </p>
              </div>
            )}
          </CardContent>
